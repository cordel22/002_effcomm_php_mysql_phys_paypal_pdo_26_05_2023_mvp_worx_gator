...
-- CREATE DATABASE IF NOT EXISTS `vladkome_002_effcomm_php_mysql_phys_paypal_online` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
-- USE `vladkome_002_effcomm_php_mysql_phys_paypal_online`;

-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.add_customer
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `add_customer`(
	IN `e` VARCHAR(80),
	IN `f` VARCHAR(20),
	IN `l` VARCHAR(40),
	IN `a1` VARCHAR(80),
...
-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.add_order
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `add_order`(
	IN `cid` INT,
	IN `uid` CHAR(32),
	IN `ship` DECIMAL(5,2),
	IN `cc` MEDIUMINT,
...
-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.add_to_cart
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `add_to_cart`(
	IN `uid` CHAR(32),
	IN `type` VARCHAR(6),
	IN `pid` MEDIUMINT,
	IN `qty` TINYINT
...
-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.add_transaction
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `add_transaction`(
	IN `oid` INT,
	IN `trans_type` VARCHAR(18),
	IN `amt` DECIMAL(7,2),
	IN `rc` TINYINT,
	IN `rrc` TINYTEXT,
	IN `tid` BIGINT,
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.carts
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.carts: 2 rows
/*!40000 ALTER TABLE `carts` DISABLE KEYS */;
INSERT INTO `carts` (`id`, `quantity`, `user_session_id`, `product_type`, `product_id`, `date_created`, `date_modified`) VALUES
	(5, 2, '27669d5fa355a7a5d7b05464ba306940', 'other', 1, '2022-04-01 20:43:18', '2022-04-01 20:50:46');
INSERT INTO `carts` (`id`, `quantity`, `user_session_id`, `product_type`, `product_id`, `date_created`, `date_modified`) VALUES
	(4, 3, '27669d5fa355a7a5d7b05464ba306940', 'coffee', 14, '2022-03-31 18:47:50', '2022-03-31 23:33:10');
/*!40000 ALTER TABLE `carts` ENABLE KEYS */;

-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.clear_cart
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `clear_cart`(
	IN `uid` CHAR(32)
)
BEGIN
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.customers
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.customers: 9 rows
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.general_coffees
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.general_coffees: 3 rows
...
-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.get_order_contents
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `get_order_contents`(
	IN `oid` INT
)
BEGIN
...
-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.get_shopping_cart_contents
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `get_shopping_cart_contents`(
	IN `uid` CHAR(32)
)
BEGIN
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.non_coffee_categories
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.non_coffee_categories: 4 rows
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.non_coffee_products
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.non_coffee_products: 4 rows
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.orders
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.orders: ~16 rows (přibližně)
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.order_contents
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.order_contents: ~18 rows (přibližně)
...
-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.remove_from_cart
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `remove_from_cart`(
	IN `uid` CHAR(32),
	IN `type` VARCHAR(6),
	IN `pid` MEDIUMINT
)
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.sales
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.sales: 7 rows
...
-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.select_categories
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `select_categories`(
	IN `TYPE` VARCHAR(6)
)
BEGIN
	IF TYPE = 'coffee' THEN
...
-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.select_products
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `select_products`(
	IN `TYPE` VARCHAR(6),
	IN `cat` TINYINT
)
BEGIN
...
-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.select_sale_items
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `select_sale_items`(
	IN `get_all` BOOLEAN
)
BEGIN
IF get_all = 1 THEN
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.sizes
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.sizes: 5 rows
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.specific_coffees
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.specific_coffees: 21 rows
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.transactions
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.transactions: 0 rows
/*!40000 ALTER TABLE `transactions` DISABLE KEYS */;
/*!40000 ALTER TABLE `transactions` ENABLE KEYS */;

-- Exportování struktury pro procedura vladkome_002_effcomm_php_mysql_phys_paypal_online.update_cart
DELIMITER //
CREATE DEFINER=`vladkome_cordel`@`localhost` PROCEDURE `update_cart`(
	IN `uid` CHAR(32),
	IN `type` VARCHAR(6),
	IN `pid` MEDIUMINT,
	IN `qty` TINYINT
...
-- Exportování struktury pro tabulka vladkome_002_effcomm_php_mysql_phys_paypal_online.wish_lists
...
-- Exportování dat pro tabulku vladkome_002_effcomm_php_mysql_phys_paypal_online.wish_lists: 0 rows
